...
const height = 550;
const width = 1100;
const colors = ["teal", "skyblue", "lightblue", "blue",
 "orange", "rgb(255, 145, 0)",
  "lightgreen","green", "darkgreen",
   "orangered", "red",
    "purple", "indigo", "maroon", "orchid", "magenta",
     "beige", "yellow"];
...
makeTheThang = () => {
    ...
    tiles.append("rect")
        .attr("class", "tile")
        .attr("stroke", "grey")
        .attr("fill", (d)=> {categ = d.data.category;
            if (categ === "Wii") {return colors[0]
                } else if(categ === "NES"){return colors[1]
                } else if(categ === "SNES"){return colors[2]
                } else if(categ === "N64"){return colors[3]

                } else if(categ === "DS"){return colors[4]
                } else if(categ === "3DS"){return colors[5]

                } else if(categ === "XB"){return colors[6]
                } else if(categ === "X360"){return colors[7]
                } else if(categ === "XOne"){return colors[8]

                } else if(categ === "GB"){return colors[9]
                } else if(categ === "GBA"){return colors[10]
    
                } else if(categ === "PS"){return colors[11]
                } else if(categ === "PS2"){return colors[12]
                } else if(categ === "PS3"){return colors[13]
                } else if(categ === "PS4"){return colors[14]
                } else if(categ === "PSP"){return colors[15]

                } else if(categ === "PC"){return colors[16]
                } else if(categ === "2600"){return colors[17]
                }})
        ...
        .on("mouseover", function(d){
            tooltip.style("visibility", "visible")
              ...
              .attr("data-value", ()=>{return this.getAttribute("data-value")})
        })
...
d3.select("body")
    .append("h1")
    .attr("id", "title")
    .text("Treemap of Top Selling Video Games")

d3.select("body")
    .append("h2")
    .attr("id", "description")
    .text("Top 100 Video Games Grouped by Platform")
